...
public class CalendarTool {
    ...
    public void setToday(){
        setGregorianDate(LocalDate.now().getYear(), LocalDate.now().getMonthValue(), LocalDate.now().getDayOfMonth());
    }

    public CalendarTool goForward(int n, int field){
        LocalDate localDate = LocalDate.of(this.getGregorianYear(), this.getGregorianMonth(), this.getGregorianDay());
        if(field == 0)
        ...
        return new CalendarTool(localDate.getYear(), localDate.getMonthValue(), localDate.getDayOfMonth());
    }

    public static int calcYearDifference(CalendarTool calendarTool1, CalendarTool calendarTool2){
        LocalDate to = LocalDate.of(calendarTool1.getGregorianYear(), calendarTool1.getGregorianMonth(), calendarTool1.getGregorianDay());
        LocalDate from = LocalDate.of(calendarTool2.getGregorianYear(), calendarTool2.getGregorianMonth(), calendarTool2.getGregorianDay());
        Period period = Period.between(from, to);
        return period.getYears();
    }

    public static int calcMonthDifference(CalendarTool calendarTool1, CalendarTool calendarTool2){
        LocalDate to = LocalDate.of(calendarTool1.getGregorianYear(), calendarTool1.getGregorianMonth(), calendarTool1.getGregorianDay());
        LocalDate from = LocalDate.of(calendarTool2.getGregorianYear(), calendarTool2.getGregorianMonth(), calendarTool2.getGregorianDay());
        Period period = Period.between(from, to);
    ...
    public static Long calcDayDifference(CalendarTool toDate, CalendarTool fromDate){
        LocalDate to = LocalDate.of(toDate.getGregorianYear(), toDate.getGregorianMonth(), toDate.getGregorianDay());
        LocalDate from = LocalDate.of(fromDate.getGregorianYear(), fromDate.getGregorianMonth(), fromDate.getGregorianDay());
        return ChronoUnit.DAYS.between(from, to);
    }

    public boolean equals(CalendarTool calendarTool) {
        if(this.gYear == calendarTool.gYear && this.gMonth == calendarTool.gMonth && this.gDay == calendarTool.gDay)
            return true;
        return false;
    }
